#!/usr/bin/env python3
"""Run F3-B.2 tests and write reproducible verification evidence."""
...
TEST_FILE = "tests/test_f3_b2_reconciliation.py"
OUT = Path("audit/f3_b2/reconciliation")
...
def main():
    ...
    evidence = {
        "phase": "F3-B.2",
        "scope": "normalized source-to-local reconciliation using InMemoryDraftEventStore",
        "command": command,
    ...
    (OUT / "VERIFICATION_RESULTS.md").write_text(
        "# F3-B.2 Reconciliation Verification Results\n\n"
