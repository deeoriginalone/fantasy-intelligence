...
TEST_FILE = "tests/test_f3_b3_live_reconciliation.py"
OUT = Path("audit/f3_b3/verification")
...
def main():
    ...
    evidence = {
        "phase": "F3-B.3",
        "scope": "read-only live Sleeper orchestration with mocked network boundaries",
        "command": command,
