...
TEST_FILE = "tests/test_f3_c1_publication_gate.py"
OUT = Path("audit/f3_c1/verification")
...
def main():
    ...
    evidence = {
        "phase": "F3-C.1",
        "scope": "readiness-enforced publication decision and execution guard",
        "command": command,
    ...
    (OUT / "VERIFICATION_RESULTS.md").write_text(
        "# F3-C.1 Publication Gate Verification\n\n"
